...
Write-Host "EMPE Skip SetupDatabase.ps1 script"
#. (Get-MyFilePath "SetupDatabase.ps1")

<#
Write-Host "EMPE try old install unattented script" 
$InstallSilent = """$navDvdPath\setup.exe /quiet /config [filename]"""
$Command = $InstallSilent
Write-Debug $Command
cmd /c $Command  
#>
